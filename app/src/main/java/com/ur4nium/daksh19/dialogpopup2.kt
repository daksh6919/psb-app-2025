...
import com.ur4nium.daksh19.databinding.ActivityDialogpopup2Binding


class MyPopupDialog2 : DialogFragment() {

    // Use view binding to access the views in the layout.
    private lateinit var binding: ActivityDialogpopup2Binding
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        binding = ActivityDialogpopup2Binding.inflate(layoutInflater)
