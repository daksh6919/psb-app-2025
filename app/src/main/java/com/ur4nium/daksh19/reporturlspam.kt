...
class ReportUrlSpam : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        // Link the Kotlin code to your XML layout file
        setContentView(R.layout.activity_reporturlspam)
        ...
        reportButton.setOnClickListener {
            ...
            val UrlAddress = UrlEditText.text.toString().trim()
            ...
            if (UrlAddress.isNotEmpty()) {
                ...
                Toast.makeText(this, "Reporting spam Email: $UrlAddress", Toast.LENGTH_SHORT).show()
            } else {
