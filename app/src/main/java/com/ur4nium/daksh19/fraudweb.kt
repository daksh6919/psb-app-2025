...
class fraudweb : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        videoDescription.text = "This video explains how to identify fake websites"
    }
    ...
    private fun fetchVideoUrlFromFirestore() {
        ...
        val videoDocRef = db.collection("fakeweb").document("video1")
        ...
        videoDocRef.get()
            ...
            .addOnFailureListener { exception ->
                ...
                Log.e("fraudweb", "Error getting document: ", exception)
